  ...
  ">
    ...
    <div class="form-check d-flex justify-content-center">
      ...
      <label class="form-check-label" for="priority_markan">
        Markan — Mark listed first allows observing the evolving descriptions of events<br>as Mark was likely written first and John last...
      </label>
    </div>
  </div>
  ...
  ">
    ...
    <div class="form-check d-flex justify-content-center">
      <input class="form-check-input me-2" type="radio" name="gospelPriority"
             id="priority_markan" value="markan">
      <label class="form-check-label" for="priority_markan">
        Markan — Mark listed first allows observing the evolving descriptions of events as Mark was likely written first and John last...
      </label>
    </div>
  </div>
  <div>The first three Gospels have darker gray headers to indicate they can be grouped as "Synoptic Gospels because..."</div>
